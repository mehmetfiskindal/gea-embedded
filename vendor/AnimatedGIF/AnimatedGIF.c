...
#if defined( PICO_BUILD ) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || defined( __EMSCRIPTEN__ ) || defined( ESP_PLATFORM ) || defined( GEA_EMBEDDED_GIF_C_API )
...
{
    return GIFGetInfo(pGIF, pInfo, pPalette);
} /* GIF_getInfo() */
